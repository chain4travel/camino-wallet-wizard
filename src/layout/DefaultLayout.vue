            ...
            <div id="footer">
                <div class="footer-content">
                    <div class="first-section">
                        ...
                        <span class="desc">
                            Camino is a fast, high-through put open-source consortium blockchain
                            enabling the creation of travel related products. Camino’s tech stack
                            and consensus protocol deliver unmatched speed, security and reliability
                            within the network
                        </span>
                    </div>
